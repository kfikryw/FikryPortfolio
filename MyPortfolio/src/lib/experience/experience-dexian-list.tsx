...
export const ExperienceDexianList = () => {
    return (
        <ul className="list-disc pl-4 text-gray-700 space-y-1 text-left">
            ...
            <li>Built reusable React components for modernization initiatives.</li>
            <li>Diagnosed production issues and optimized legacy modules for better reliability.</li>
            <li>Authored deployment cookbook to standardize release processes.</li> */}
        </ul>
    )
}